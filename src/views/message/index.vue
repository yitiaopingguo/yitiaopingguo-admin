  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="搜索：">
        <el-input size="small" v-model="formInline.deptName" placeholder="输入留言名称"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="deptName" label="留言内容" min-width="100" max-width="300">
      </el-table-column>
      <el-table-column sortable prop="editTime" label="留言时间" min-width="100" max-width="300">
